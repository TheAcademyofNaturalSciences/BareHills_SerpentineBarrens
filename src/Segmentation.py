...
inras = r'T:\WilliamPenn_Share\EDS\BARE_HILLS\DATA\SPATIAL\barehills6in_prj_s2_composite.tif'
spatialr = 16   # Changing this parameter will effect run-time, higher means more avg.ing -> more time
ranger = 28
minsize = 32
cleanup = 'True'
ram = 1000
