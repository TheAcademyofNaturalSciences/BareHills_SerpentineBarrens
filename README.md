...
For this project Orfeo ToolBox (otbApplication in Python) was utilized to radiometrically segment the image. The segments and their spectral properties were then pulled into R, where a random forest classifier placed each segment into a predicted land cover category.
